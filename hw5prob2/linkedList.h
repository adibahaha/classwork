...
/*Add the operation divideMid to the class linkedListType as follows;
 ...
 The function divides the given list into two sublists of (almost) equal sizes.

 At the function's completion the class member first points to the first node and last points to the last node of the first sublist.

 sublist.first points ot hte first node and sublist.last points to  the last node of the second sublist.
 ...
 Supose myList points to the list with elements 34 65 27 89 12 (in this order). The statement :

 myLIst.divideMid(subList);

 divides myList into two sublists: myList points to the list with the elements 34 65 27, and subList points the list with the elements 89 12.
...
void linkedListType<Type>::divideMid(linkedListType<Type> &sublist)
{
    ...
    if((count%2)!=0)
        countmylist = count/2+1;
    else
        countmylist = count/2;
    countsublist = count-countmylist;
